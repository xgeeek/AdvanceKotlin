package com.advance.kotlin.kline.demo;
...
import com.advance.kotlin.kline.demo.adapters.NormalSpinerAdapter;
import com.advance.kotlin.kline.demo.entity.BTC123MarketData;
import com.advance.kotlin.kline.demo.entity.ChartData;
import com.advance.kotlin.kline.demo.entity.MarketDataResult;
import com.advance.kotlin.kline.demo.tool.HttpMethods;
import com.advance.kotlin.kline.demo.tool.SubscriberOnNextListener;
import com.advance.kotlin.kline.demo.view.SpinerPopWindow;
import com.advance.kotlin.kline.entity.MarketChartData;
import com.advance.kotlin.kline.view.KView;
...
public class KDiagramActivity extends Activity implements View.OnClickListener {
    ...
    private void getMarketDataByWebservice() {
        Subscriber subscriber = new Subscriber<MarketDataResult>() {
            ...
            @Override
            public void onError(Throwable e) {
                Log.d("getMarketData",e.getMessage());
            }
