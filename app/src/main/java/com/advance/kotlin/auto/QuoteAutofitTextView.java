 ...
 */
public class QuoteAutofitTextView extends androidx.appcompat.widget.AppCompatTextView implements AutofitHelper.OnTextSizeChangeListener {

    private AutofitHelper mHelper;

    public QuoteAutofitTextView(Context context) {
        super(context);
        init(context, null, 0);
    }

    public QuoteAutofitTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, 0);
    }

    public QuoteAutofitTextView(Context context, AttributeSet attrs, int defStyle) {
