package com.advance.kotlin.auto;
...
/**
 * A helper class to enable automatically resizing {@link AppCompatTextView}`s {@code textSize} to fit
 * within its bounds.
 *
...
public class AutofitHelper {
    ...
    /**
     * Creates a new instance of {@code AutofitHelper} that wraps a {@link AppCompatTextView} and enables
     * automatically sizing the text to fit.
     */
    public static AutofitHelper create(AppCompatTextView view) {
     ...
     * automatically sizing the text to fit.
     */
    public static AutofitHelper create(AppCompatTextView view, AttributeSet attrs) {
    ...
    public static AutofitHelper create(AppCompatTextView view, AttributeSet attrs, int defStyle) {
        ...
        if (attrs != null) {
            ...
            TypedArray ta = context.obtainStyledAttributes(
                    attrs,
                    R.styleable.QuoteAutofitTextView,
                    defStyle,
                    0);
            sizeToFit = ta.getBoolean(R.styleable.QuoteAutofitTextView_sizeToFit, sizeToFit);
            minTextSize = ta.getDimensionPixelSize(R.styleable.QuoteAutofitTextView_minTextSize,
                    minTextSize);
            precision = ta.getFloat(R.styleable.QuoteAutofitTextView_precision, precision);
            ta.recycle();
    ...
    private static void autofit(AppCompatTextView view, TextPaint paint, float minTextSize, float maxTextSize,
        ...
        if ((maxLines == 2 && paint.measureText(text, 0, text.length()) > targetWidth)
    ...
    private AutofitHelper(AppCompatTextView view) {
     ...
     * whenever the {@link AppCompatTextView}'s {@code textSize} changes.
     */
     ...
     * are called whenever the {@link AppCompatTextView}'s {@code textSize} changes.
     */
    ...
    /**
     * @see AppCompatTextView#getMaxLines()
     */
    ...
    /**
     * @see AppCompatTextView#setMaxLines(int)
     */
     ...
     *
     * @see AppCompatTextView#getTextSize()
     */
     ...
     *
     * @see AppCompatTextView#setTextSize(float)
     */
     ...
     * Set the original text size of the View.
     *
     * @see AppCompatTextView#setTextSize(int, float)
     */
